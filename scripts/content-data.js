...
const CATALOG = [
  ...
  { slug: "gas-water-heater-installation-westchester-ny", name: "Gas Water Heater Installation", cat: "gasfitter-westchester-ny", group: "water", blurb: "Safe, code-compliant gas water heater replacement and venting." },
  ...
  { slug: "boiler-installation-westchester-ny", name: "Boiler Installation", cat: "gasfitter-westchester-ny", group: "water", blurb: "Reliable boiler replacement for older Westchester homes and finished basements." },
  ...
  { slug: "toilet-installation-westchester-ny", name: "Toilet Installation", cat: "bathroom-remodeler-westchester-ny", group: "fixtures", blurb: "New toilets set level, sealed, and leak-tested." },
  { slug: "leak-detection-westchester-ny", name: "Leak Detection", cat: "water-damage-restoration-westchester-ny", group: "repair", blurb: "Find hidden leaks behind walls and under floors without guesswork." },
  ...
  { slug: "burst-pipe-repair-westchester-ny", name: "Burst Pipe Repair", cat: "water-damage-restoration-westchester-ny", group: "repair", blurb: "Emergency burst-pipe response to stop the water and restore your plumbing." },
  ...
  { slug: "slab-leak-repair-westchester-ny", name: "Slab Leak Repair", cat: "water-damage-restoration-westchester-ny", group: "repair", blurb: "Locate and fix leaks in pipes running under a concrete slab." },
  ...
  { slug: "sewer-line-repair-westchester-ny", name: "Sewer Line Repair", cat: "drainage-service-westchester-ny", group: "repair", blurb: "Fix cracked, clogged, or root-invaded sewer lines." },
  ...
  { slug: "shower-installation-westchester-ny", name: "Shower Installation", cat: "bathroom-remodeler-westchester-ny", group: "fixtures", blurb: "Shower and valve installation done clean and watertight." },
  { slug: "shower-valve-replacement-westchester-ny", name: "Shower Valve Replacement", cat: "bathroom-remodeler-westchester-ny", group: "fixtures", blurb: "Fix temperature and pressure problems with a new shower valve." },
  { slug: "bathtub-installation-westchester-ny", name: "Bathtub Installation", cat: "bathroom-remodeler-westchester-ny", group: "fixtures", blurb: "Tub replacement and installation with proper drain connections." },
  ...
  { slug: "sump-pump-installation-westchester-ny", name: "Sump Pump Installation", cat: "water-damage-restoration-westchester-ny", group: "repair", blurb: "Keep finished basements dry with a properly installed sump pump." },
